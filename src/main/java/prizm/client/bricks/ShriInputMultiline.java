...
public class ShriInputMultiline extends FormGroup implements ShriInputInterface {
    private static String TAG = "texte";
    private static int counter = 0;

    public static interface ShriInputHandler {
        public void onChange(ShriInput input);
    }
    ...
    private ShriInput.ShriInputHandler shriHandler = null;
    ...
    public ShriInputMultiline(String title, String placeHolder, ShriInput.ShriInputHandler handler) {
    ...
    public ShriInputMultiline(String title, String placeHolder) {
        this(title,placeHolder,null,false);
    }

    public ShriInputMultiline(String title, String placeHolder, String predefined, boolean allowCopy) {
        add(formLabel);
    ...
    public void setShriInputHandler(ShriInput.ShriInputHandler shriInputHandler) {
